...
class NotifyReciever {
  static const MethodChannel _channel = const MethodChannel('notify_reciever');
  static const EventChannel _eventChannel = const EventChannel('notify_stream');

  static Future<Intent?> getInitialIntent() async {
    final renameMap = await _channel.invokeMapMethod('getInitialIntent');
  ...
  static Future<void> setResult(int resultCode,
    ...
    await _channel.invokeMethod('setResult', <String, dynamic>{
